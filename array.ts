...
const faculty=["Minnahil","Dua","Hamza","Ameen Alam","Bilal" ]
 ...
 let newArray:string[]=["Maria","Minnahil","Hamza"] //if we assign type string in array then we cannot define number will be show error. 
 //so we wil remove it.
 console.log(countries,mixedArray)
console.log(newArray[1])
console.log(countries[4],countries[3])
console.log(faculty[2])
let daysName: string[]=["friday","saturday","monday","tuesday","wednesday","thursday"]
let dayNumber:number[]=[1,2,3,4,5,6,7]
...
let teacher:string[]=["SUMNA","FARHA","SAMREEN","ASMA","IRUM"]
